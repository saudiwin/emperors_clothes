...
The Middle East and North Africa is often considered one of the most restrictive and least democratic regions in the world. Scholars have pointed to the role of external powers, rentier states, and religious or secterian conflict as possible culprits behind this regional distinction [@brumberg2002; @brownlee2012; @yom2015; @jamal2009; @ross2012]. As a result, it is not surprising that social science research has likewise suffered significant headwinds due to the difficulty in collecting survey data when Arab regimes ban or heavily regulate such activity [@benstead2018].
...
# fit5 <- brm(bf(kais_combined | vint(treatment) ~ vote_pres + (1|gov), 
#           bias ~ (1|gov)), 
#             data=survey_data,
#             family=family_sens_reg,
#             stanvars=all_stanvars,
...
coefficient_map <- c(
  ...
  "b_emigrate_thoughts.L" = "Emigrate",
  "b_bias_pol_ideo_diff" = "Ideology Distance",
  "b_bias_emigrate_thoughts.L" = "Emigrate",
